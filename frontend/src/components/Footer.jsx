...
export default function Footer() {
  ...
  return (
    <Animate>
      <footer
        className={`mx-2 mt-5 relative bottom-2  backdrop-blur-sm bg-transparent rounded-t-2xl ${theme === "dark" ? "footer-dark-shadow" : "footer-light-shadow"}`}
      >
        {/* First Row  */}
        <div className="flex flex-col sm:flex-row sm:mx-20 mx-4 py-8 gap-10">
          ...
          <div className="sm:max-w-xs space-y-4">
            ...
            <p className="leading-6">
              Your complete placement preparation partner. From first year to
              final placement, we've got you covered.
            </p>
            ...
            <div className="border flex space-x-4 max-w-3/4 items-center p-2 bg-white/20 rounded-md border-gray-300">
              ...
              <p className="font-extrabold text-md text-brand-gradient">
          ...
          <div className="flex flex-col sm:flex-row-reverse flex-1 sm:flex-wrap sm:justify-between gap-6">
            <div className="space-y-6">
              <h5 className="text-secondary text-md font-family-abril-fatface">
                Stay Updated
              </h5>
            ...
            <div className="space-y-6">
              ...
              <ul className="flex flex-col gap-3">
                <Link
                  to={"/contributors#top"}
                  className="transition-transform transform hover:underline"
                >
                  Our Contributors
                </Link>
                <Link
        ...
        <div className="flex items-center justify-center border-t-2 sm:mx-20 mx-4 py-6 border-gray-300">
          <span className="text-xl mx-1 font-light">&copy;</span> 2025 KMPM
          CampusPrep. All rights reserved.
        </div>
      </footer>
    </Animate>
  );
